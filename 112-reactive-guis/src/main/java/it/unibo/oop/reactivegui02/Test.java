...
public final class Test {
     ...
     * figura allegata (e contatore inizialmente posto a zero). DONE
     *
     ...
     * modo alternato. DONE
     *
     * Alla pressione del pulsante "stop", il conteggio si blocchi DONE, e i tre
     * pulsanti vengano disabilitati. Per far partire l'applicazioni si tolga il
     * commento nel main qui sotto. DONE
     *
